          ...
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label for="pesansms">Pesan</label>
                  <textarea class="textarea" id="pesansms" name="pesanemail" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $pecah['pesan_email'] ?></textarea>
                </div>
              </div>
              <div class="card-footer">
