...
<body class="bg_login" style="overflow: hidden;">
            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                <div class="block block-themed animated fadeIn">
                    ...
                    <div class="block-content block-content-full block-content-narrow">
                        <center>
                            <br><br><br><br><br>
                            <p class="h1 font-w600 push-30-t push-5" style="color:white; font-family:fantasy">REDJO RENT CAR</p>
                            <!-- <img src="<?php echo base_url(); ?>assets/img/logo.png" width="400px"> -->
                        </center>
                        <br>
